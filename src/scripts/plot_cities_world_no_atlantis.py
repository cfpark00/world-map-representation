#!/usr/bin/env python3
"""World map plot - all cities EXCEPT Atlantis, colored by region with legend."""
...
# Display names map "India" -> "South Asia" for the legend
REGION_COLORS = {
    "Africa": "#636EFA",
    "Central Asia": "#00CC96",
    "China": "#AB63FA",
...
# Display names for legend (rename India to South Asia)
DISPLAY_NAMES = {
    "Africa": "Africa",
...
def main(config_path, overwrite=False):
    ...
    print(f"After excluding Atlantis: {len(df):,} cities")
    ...
    plt.tight_layout()
    output_path = figures_dir / 'world_no_atlantis.png'
