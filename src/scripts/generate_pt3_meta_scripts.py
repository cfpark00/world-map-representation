#!/usr/bin/env python3
"""
Generate meta scripts for pt3-{1-8} like exp2 has for pt2-{1-8}.
"""
...
def generate_meta_scripts():
    """Generate run_pt3-X_all.sh meta scripts for exp5."""
    base_dir = Path("scripts/revision/exp5")
...
bash scripts/revision/exp5/pt3_seed/pt3-{pt3_num}/pt3-{pt3_num}_seed1.sh

echo ""
echo "=== Training pt3-{pt3_num} seed2 ==="
bash scripts/revision/exp5/pt3_seed/pt3-{pt3_num}/pt3-{pt3_num}_seed2.sh
...
"""
    ...
    print(f"\nGenerated 8 meta scripts for pt3-{'{1-8}'}")
