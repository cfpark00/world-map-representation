#!/usr/bin/env python
"""Collect and zip all pt1_ftwb2-X PCA timeline HTML files."""
...
def main():
    ...
    for x in x_range:
        for y_suffix in y_suffixes:
            # Construct the path
            html_path = base_path / f"pt1_ftwb2-{x}" / "analysis_higher" / "distance_firstcity_last_and_trans_l5" / f"pca_timeline{y_suffix}" / "pca_3d_timeline.html"
