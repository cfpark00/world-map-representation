...
for i in range(n):
    for j in range(i, n):  # Upper triangle + diagonal
        ...
        result_dir = base_dir / f'{exp1_name}_vs_{exp2_name}' / 'layer4'
        summary_file = result_dir / 'summary.json'

        # If not found, try the reverse ordering
        if not summary_file.exists():
            result_dir = base_dir / f'{exp2_name}_vs_{exp1_name}' / 'layer4'
            summary_file = result_dir / 'summary.json'
...
# Title
title = f'21×21 CKA Matrix (Layer 4)\n'
...
# Save 7x7 with SEM
output_path_7x7_sem = output_dir / 'cka_matrix_7x7_averaged_layer4_with_sem.png'
...
output_path_7x7 = output_dir / 'cka_matrix_7x7_averaged_layer4.png'
...
csv_path_7x7 = output_dir / 'cka_matrix_7x7_averaged_layer4.csv'
...
# Save bar plot
output_path_bar = output_dir / 'cka_barplot_intra_vs_inter_layer4.png'
