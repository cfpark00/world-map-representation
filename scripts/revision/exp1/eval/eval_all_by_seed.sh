...
bash scripts/revision/exp1/eval/eval_seed2_ftwb2-8-14.sh
bash scripts/revision/exp1/eval/eval_seed3_ftwb2-8-14.sh
bash scripts/revision/exp1/eval/eval_seed1_ftwb2-15-21.sh
bash scripts/revision/exp1/eval/eval_seed2_ftwb2-15-21.sh
bash scripts/revision/exp1/eval/eval_seed3_ftwb2-15-21.sh
